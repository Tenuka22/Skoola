...
impl PropertyService {
    pub fn create_category(conn: &mut SqliteConnection, req: CreateAssetCategoryRequest) -> Result<AssetCategory, APIError> {
        ...
        diesel::insert_into(asset_categories::table).values(&new_cat).execute(conn).map_err(|e| APIError::internal(&e.to_string()))?;
        Ok(new_cat)
    }

    pub fn get_categories(conn: &mut SqliteConnection) -> Result<Vec<AssetCategory>, APIError> {
        asset_categories::table.load::<AssetCategory>(conn).map_err(|e| APIError::internal(&e.to_string()))
    }
    ...
    pub fn create_inventory_item(conn: &mut SqliteConnection, req: CreateInventoryItemRequest) -> Result<InventoryItem, APIError> {
        ...
        diesel::insert_into(inventory_items::table).values(&new_item).execute(conn).map_err(|e| APIError::internal(&e.to_string()))?;
        Ok(new_item)
    }

    pub fn get_inventory_by_category(conn: &mut SqliteConnection, cat_id: &str) -> Result<Vec<InventoryItem>, APIError> {
        inventory_items::table.filter(inventory_items::category_id.eq(cat_id)).load::<InventoryItem>(conn).map_err(|e| APIError::internal(&e.to_string()))
    }
    ...
    pub fn create_uniform_item(conn: &mut SqliteConnection, req: CreateUniformItemRequest) -> Result<UniformItem, APIError> {
        ...
        diesel::insert_into(uniform_items::table).values(&new_item).execute(conn).map_err(|e| APIError::internal(&e.to_string()))?;
        Ok(new_item)
    }
    ...
    pub fn issue_uniform(conn: &mut SqliteConnection, req: IssueUniformRequest) -> Result<UniformIssue, APIError> {
        ...
        diesel::insert_into(uniform_issues::table).values(&new_issue).execute(conn).map_err(|e| APIError::internal(&e.to_string()))?;
    ...
    pub fn allocate_asset(conn: &mut SqliteConnection, req: AllocateAssetRequest) -> Result<AssetAllocation, APIError> {
        ...
        diesel::insert_into(asset_allocations::table).values(&new_alloc).execute(conn).map_err(|e| APIError::internal(&e.to_string()))?;
    ...
    pub fn create_maintenance_request(conn: &mut SqliteConnection, req: CreateMaintenanceRequest) -> Result<MaintenanceRequest, APIError> {
        ...
        diesel::insert_into(maintenance_requests::table).values(&new_req).execute(conn).map_err(|e| APIError::internal(&e.to_string()))?;
        Ok(new_req)
    }
    ...
    pub fn update_inventory_item(conn: &mut SqliteConnection, id: &str, req: UpdateInventoryItemRequest) -> Result<InventoryItem, APIError> {
        ...
        inventory_items::table.find(id).first(conn).map_err(|e| APIError::internal(&e.to_string()))
    }
    ...
    pub fn return_asset(conn: &mut SqliteConnection, id: &str, req: ReturnAssetRequest) -> Result<AssetAllocation, APIError> {
        ...
        let alloc: AssetAllocation = asset_allocations::table.find(id).first(conn).map_err(|e| APIError::internal(&e.to_string()))?;
        ...
        asset_allocations::table.find(id).first(conn).map_err(|e| APIError::internal(&e.to_string()))
    }
    ...
    pub fn update_maintenance_status(conn: &mut SqliteConnection, id: &str, req: UpdateMaintenanceStatusRequest) -> Result<MaintenanceRequest, APIError> {
        ...
        maintenance_requests::table.find(id).first(conn).map_err(|e| APIError::internal(&e.to_string()))
    }
