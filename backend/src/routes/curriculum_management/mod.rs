...
pub fn configure(cfg: &mut web::ServiceConfig) {
    cfg.service(
        web::scope("/curriculum-topics")
            ...
            .route("/bulk", web::patch().to(topics::bulk_update_curriculum_topic)),
    )
    .service(
    ...
    .service(
        web::scope("/lesson-progress-attachments")
            ...
            .route("/bulk", web::patch().to(crate::handlers::curriculum_management::attachments::bulk_update_lesson_progress_attachment)),
    )
    .service(
