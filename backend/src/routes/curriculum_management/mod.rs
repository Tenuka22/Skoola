...
pub fn configure(cfg: &mut web::ServiceConfig) {
    cfg.service(
        web::scope("/curriculum-standards")
            ...
            .service(
                web::resource("")
                    .wrap(PermissionVerification { required_permission: PermissionEnum::CurriculumCreate })
                    .route(web::post().to(curriculum_management::create_curriculum_standard)),
            )
            .service(
                web::resource("/{standard_id}")
                    .wrap(PermissionVerification { required_permission: PermissionEnum::CurriculumRead })
            ...
            .service(
                web::resource("/{standard_id}")
                    .wrap(PermissionVerification { required_permission: PermissionEnum::CurriculumUpdate })
                    .route(web::put().to(curriculum_management::update_curriculum_standard)),
            )
            .service(
                web::resource("/{standard_id}")
                    .wrap(PermissionVerification { required_permission: PermissionEnum::CurriculumDelete })
                    .route(web::delete().to(curriculum_management::delete_curriculum_standard)),
            )
            .service(
                web::resource("/{standard_id}/syllabus")
                    .wrap(PermissionVerification { required_permission: PermissionEnum::SyllabusRead })
    ...
    .service(
        web::scope("/syllabus")
            ...
            .service(
                web::resource("")
                    .wrap(PermissionVerification { required_permission: PermissionEnum::SyllabusCreate })
            ...
            .service(
                web::resource("/{syllabus_id}")
                    .wrap(PermissionVerification { required_permission: PermissionEnum::SyllabusUpdate })
                    .route(web::put().to(curriculum_management::update_syllabus_topic)),
            )
            .service(
                web::resource("/{syllabus_id}")
                    .wrap(PermissionVerification { required_permission: PermissionEnum::SyllabusDelete })
