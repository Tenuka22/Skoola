use crate::database::enums::{
    ...
    SubstitutionStatus, SuspicionFlag, TransactionType,
};
use crate::schema::{
    activities, activity_attendance, activity_participants, activity_types, asset_allocations,
    asset_categories, attendance_audit_log, attendance_discrepancies, attendance_excuses,
    attendance_policies, budget_categories, budgets, detention_balances,
    emergency_roll_call_entries, emergency_roll_calls, exit_passes, expense_categories,
    expense_transactions, fee_categories, fee_payments, fee_structures, income_sources,
    income_transactions, inventory_items, lesson_progress, library_books, library_categories,
    library_issues, library_settings, maintenance_requests, petty_cash_transactions,
    pre_approved_absences, role_permissions, salary_components, salary_payments, school_calendar,
    school_settings, sessions, staff, staff_attendance, staff_departments,
    staff_employment_history, staff_leaves, staff_qualifications, staff_salaries, staff_subjects,
