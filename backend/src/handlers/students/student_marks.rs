...
pub async fn get_student_marks_by_student_id(
    ...
    let student_marks =
        student_marks::get_student_marks_by_student_id(data.clone(), student_id).await?;
    Ok(Json(student_marks))
}
...
pub async fn get_student_marks_by_exam_and_class(
    ...
    let student_marks =
        student_marks::get_student_marks_by_exam_and_class(data.clone(), exam_id, class_id).await?;
    Ok(Json(student_marks))
}
