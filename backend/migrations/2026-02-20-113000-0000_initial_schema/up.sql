...
CREATE TABLE users_amended ( -- Placeholder if needed, but Group 1 is sufficient
    id TEXT PRIMARY KEY NOT NULL
);
...
-- Group 5: Tables with Foreign Keys to Group 4
...
-- Group 6: System Tables (Diesel)
-- CREATE TABLE __diesel_schema_migrations ( ... ); -- Handled by Diesel
