...
export const AllocationTypeSchema = {
  type: 'string',
  enum: ['Student', 'Teacher', 'Department', 'Class'],
} as const
...
export const CreateAcademicYearRequestSchema = {
  ...
  type: 'object',
  required: ['name', 'year_end', 'year_start'],
  properties: {
    current: {
      type: 'boolean',
      nullable: true,
...
export const CreateGradeLevelRequestSchema = {
  ...
  type: 'object',
  required: ['education_level', 'grade_name', 'grade_number'],
  properties: {
    education_level: {
...
export const CreatePermissionRequestSchema = {
  ...
  type: 'object',
  required: ['description', 'name', 'safety_level'],
  properties: {
    description: {
      type: 'string',
    },
...
export const CreateStudentGuardianRequestSchema = {
  ...
  type: 'object',
  required: ['address', 'name', 'phone', 'relationship', 'student_id'],
  properties: {
    address: {
      type: 'string',
    },
...
export const CreateSubjectRequestSchema = {
  ...
  type: 'object',
  required: ['subject_code', 'subject_name_en'],
  properties: {
    is_core: {
      type: 'boolean',
      nullable: true,
...
export const PaginatedStudentResponseSchema = {
  ...
  type: 'object',
  required: ['limit', 'offset', 'students', 'total_students'],
  properties: {
    limit: {
      type: 'integer',
      format: 'int64',
...
export const PermissionSchema = {
  title: 'Permission',
  type: 'object',
  required: ['description', 'id', 'is_admin_only', 'name', 'safety_level'],
  properties: {
    description: {
      type: 'string',
    },
...
export const UserResponseSchema = {
  type: 'object',
  required: ['created_at', 'email', 'id', 'is_verified', 'updated_at'],
  properties: {
    created_at: {
      type: 'string',
      format: 'partial-date-time',
