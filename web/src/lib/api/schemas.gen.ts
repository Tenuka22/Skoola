...
export const AssignSubjectToTeacherRequestSchema = {
  ...
  type: 'object',
  required: ['academic_year_id', 'medium', 'subject_id'],
  properties: {
    academic_year_id: {
      type: 'string',
    },
...
export const RewardReasonTypeSchema = {
  type: 'string',
  enum: [
    'LessonCompleted',
    'SubstitutionDone',
...
export const TeacherRewardHistorySchema = {
  ...
  type: 'object',
  required: ['created_at', 'id', 'points', 'reason_type', 'teacher_id'],
  properties: {
    created_at: {
      type: 'string',
      format: 'partial-date-time',
    ...
    reason_type: {
      $ref: '#/components/schemas/RewardReasonType',
    },
    reference_id: {
      type: 'string',
      nullable: true,
...
export const TeacherSubjectAssignmentResponseSchema = {
  ...
  type: 'object',
  required: ['academic_year_id', 'id', 'medium', 'subject_id', 'teacher_id'],
  properties: {
    academic_year_id: {
      type: 'string',
    },
