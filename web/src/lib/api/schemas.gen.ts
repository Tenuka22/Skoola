...
export const AllocateAssetRequestSchema = {
  ...
  type: 'object',
  required: ['allocated_by', 'item_id', 'quantity'],
  properties: {
    allocated_by: {
      type: 'string',
    },
...
export const ApplyWaiverRequestSchema = {
  ...
  type: 'object',
  required: ['discount_amount', 'reason'],
  properties: {
    discount_amount: {
      type: 'number',
      format: 'float',
...
export const AssignFeeToStudentRequestSchema = {
  ...
  type: 'object',
  required: ['amount', 'fee_structure_id', 'student_id'],
  properties: {
    amount: {
      type: 'number',
      format: 'float',
...
export const AssignSubjectToTeacherRequestSchema = {
  ...
  type: 'object',
  required: ['academic_year_id', 'subject_id'],
  properties: {
    academic_year_id: {
      type: 'string',
    },
...
export const AttendanceExcuseResponseSchema = {
  ...
  type: 'object',
  required: ['attendance_record_id', 'excuse_type', 'id', 'is_verified'],
  properties: {
...
export const AuthMethodStatsSchema = {
  type: 'object',
  required: ['github', 'google', 'password_only'],
  properties: {
    github: {
      type: 'integer',
      format: 'int64',
...
export const BulkAssignFeesRequestSchema = {
  ...
  type: 'object',
  required: ['academic_year_id', 'fee_structure_id', 'grade_id'],
  properties: {
    academic_year_id: {
      type: 'string',
    },
...
export const BulkMarkStaffAttendanceRequestSchema = {
  ...
  type: 'object',
  required: ['attendance_records', 'date'],
  properties: {
    attendance_records: {
      type: 'array',
      items: {
...
export const CreateConversationRequestSchema = {
  ...
  type: 'object',
  required: ['participant_ids', 'subject'],
  properties: {
    participant_ids: {
      type: 'array',
      items: {
...
export const CreateCulturalEventRequestSchema = {
  ...
  type: 'object',
  required: ['event_date', 'event_name', 'venue'],
  properties: {
    description: {
      type: 'string',
      nullable: true,
...
export const CreateCurriculumStandardRequestSchema = {
  ...
  type: 'object',
  required: ['grade_level_id', 'standard_code', 'subject_id'],
  properties: {
    description: {
      type: 'string',
      nullable: true,
...
export const CreateMaintenanceRequestSchema = {
  ...
  type: 'object',
  required: ['issue_description', 'item_id', 'reported_by'],
  properties: {
    issue_description: {
      type: 'string',
    },
...
export const CreateSportEventRequestSchema = {
  ...
  type: 'object',
  required: ['event_date', 'event_name', 'organizer', 'sport_id', 'venue'],
  properties: {
    event_date: {
      type: 'string',
      format: 'partial-date-time',
...
export const CreateStudentAchievementRequestSchema = {
  ...
  type: 'object',
  required: ['achievement_type', 'date', 'description', 'student_id'],
  properties: {
    achievement_type: {
      type: 'string',
    },
...
export const CreateStudentMarkRequestSchema = {
  type: 'object',
  required: ['exam_id', 'marks_obtained', 'student_id', 'subject_id'],
  properties: {
    exam_id: {
      type: 'string',
    },
...
export const CreateSyllabusRequestSchema = {
  ...
  type: 'object',
  required: ['curriculum_standard_id', 'topic_name'],
  properties: {
...
export const CreateUniformItemRequestSchema = {
  ...
  type: 'object',
  required: ['gender', 'item_name', 'price', 'quantity', 'size'],
  properties: {
    gender: {
      type: 'string',
    },
...
export const EnrollParticipantRequestSchema = {
  ...
  type: 'object',
  required: ['participant_type', 'user_id'],
  properties: {
    enrollment_reason: {
      type: 'string',
      nullable: true,
...
export const EnrollStudentInSubjectRequestSchema = {
  ...
  type: 'object',
  required: ['academic_year_id', 'student_id', 'subject_id'],
  properties: {
    academic_year_id: {
      type: 'string',
    },
...
export const EthnicitySchema = {
  type: 'string',
  enum: ['Sinhala', 'Tamil', 'Muslim', 'Burger', 'Malay', 'Vedda', 'Other'],
} as const

export const ExamRegistrationRequestSchema = {
  title: 'ExamRegistrationRequest',
  type: 'object',
  required: ['exam_year', 'student_id'],
  properties: {
    exam_year: {
      type: 'integer',
      format: 'int32',
...
export const FeePaymentHistoryResponseSchema = {
  ...
  type: 'object',
  required: ['balance', 'payments', 'total_paid'],
  properties: {
    balance: {
      type: 'number',
      format: 'float',
...
export const GradeFeeCollectionReportSchema = {
  ...
  type: 'object',
  required: ['grade_id', 'grade_name', 'total_collected', 'total_expected'],
  properties: {
    grade_id: {
      type: 'string',
    },
...
export const GradingCriterionSchema = {
  ...
  type: 'object',
  required: ['grade', 'id', 'max_marks', 'min_marks', 'scheme_id'],
  properties: {
    created_at: {
      type: 'string',
      format: 'partial-date-time',
...
export const LeaveBalanceResponseSchema = {
  ...
  type: 'object',
  required: ['leave_type', 'staff_id', 'total_days_taken'],
  properties: {
    leave_type: {
      type: 'string',
    },
...
export const MessageResponseSchema = {
  ...
  type: 'object',
  required: ['content', 'conversation_id', 'id', 'sender_user_id', 'sent_at'],
  properties: {
    content: {
      type: 'string',
    },
...
export const PaymentMethodSchema = {
  type: 'string',
  enum: ['Cash', 'BankTransfer', 'Cheque', 'Online'],
} as const
...
export const RecordFeePaymentRequestSchema = {
  ...
  type: 'object',
  required: ['amount_paid', 'collected_by', 'payment_method', 'student_fee_id'],
  properties: {
    amount_paid: {
      type: 'number',
      format: 'float',
...
export const RecordIncomeRequestSchema = {
  ...
  type: 'object',
  required: ['amount', 'receipt_number', 'received_by', 'source_id'],
  properties: {
    amount: {
      type: 'number',
      format: 'float',
...
export const RecordPettyCashRequestSchema = {
  ...
  type: 'object',
  required: ['amount', 'handled_by', 'transaction_type'],
  properties: {
    amount: {
      type: 'number',
      format: 'float',
...
export const ReligionSchema = {
  type: 'string',
  enum: ['Buddhism', 'Hinduism', 'Islam', 'Christianity', 'Other'],
} as const
...
export const SalaryComponentResponseSchema = {
  ...
  type: 'object',
  required: ['component_type', 'created_at', 'id', 'name', 'updated_at'],
  properties: {
    component_type: {
      $ref: '#/components/schemas/ComponentType',
    },
...
export const TeacherClassAssignmentResponseSchema = {
  ...
  type: 'object',
  required: ['academic_year_id', 'class_id', 'id', 'teacher_id'],
  properties: {
    academic_year_id: {
      type: 'string',
    },
...
export const TeacherSubjectAssignmentResponseSchema = {
  ...
  type: 'object',
  required: ['academic_year_id', 'id', 'subject_id', 'teacher_id'],
  properties: {
    academic_year_id: {
      type: 'string',
    },
...
export const TeacherWorkloadResponseSchema = {
  ...
  type: 'object',
  required: ['teacher_id', 'total_classes_assigned', 'total_subjects_assigned'],
  properties: {
    teacher_id: {
      type: 'string',
    },
...
export const UserProfileResponseSchema = {
  ...
  type: 'object',
  required: ['created_at', 'email', 'id', 'is_verified', 'roles', 'updated_at'],
  properties: {
    address: {
      type: 'string',
      nullable: true,
...
export const UserResponseSchema = {
  title: 'UserResponse',
  type: 'object',
  required: ['created_at', 'email', 'id', 'is_verified', 'role', 'updated_at'],
  properties: {
    created_at: {
      type: 'string',
      format: 'partial-date-time',
