...
import { createStudentSchema, genderSchema, ethnicitySchema, religionSchema, studentStatusSchema, type CreateStudentValues } from '../schemas'
import type { Gender, Ethnicity, Religion, StudentStatus } from '../schemas'
import {
  Field,
  FieldError,
  FieldGroup,
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
      <FieldGroup className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Field>
            <FieldLabel className="text-xs font-black uppercase tracking-widest opacity-50">Admission Number</FieldLabel>
            <Input 
          ...
          <Field>
            <FieldLabel className="text-xs font-black uppercase tracking-widest opacity-50">English Name</FieldLabel>
            <Input 
          ...
          <Field>
            <FieldLabel className="text-xs font-black uppercase tracking-widest opacity-50">Sinhala Name (Optional)</FieldLabel>
            <Input 
          ...
          <Field>
            <FieldLabel className="text-xs font-black uppercase tracking-widest opacity-50">Tamil Name (Optional)</FieldLabel>
            <Input 
              {...register('name_tamil')} 
          ...
          <Field>
            <FieldLabel className="text-xs font-black uppercase tracking-widest opacity-50">Email (Optional)</FieldLabel>
            <Input 
              {...register('email')} 
          ...
          <Field>
            <FieldLabel className="text-xs font-black uppercase tracking-widest opacity-50">NIC / Birth Certificate No.</FieldLabel>
            <Input 
          ...
          <Field>
            ...
            <Select onValueChange={(val) => setValue('gender', val as Gender)} defaultValue={gender}>
          ...
          <Field>
            <FieldLabel className="text-xs font-black uppercase tracking-widest opacity-50">Ethnicity (Optional)</FieldLabel>
            <Select onValueChange={(val) => setValue('ethnicity', val as Ethnicity)} defaultValue={ethnicity || ''}>
              <SelectTrigger className="h-12 rounded-2xl border-none bg-muted/30 px-4 font-bold focus:ring-2 focus:ring-primary">
          ...
          <Field>
            <FieldLabel className="text-xs font-black uppercase tracking-widest opacity-50">Religion (Optional)</FieldLabel>
            <Select onValueChange={(val) => setValue('religion', val as Religion)} defaultValue={religion || ''}>
              <SelectTrigger className="h-12 rounded-2xl border-none bg-muted/30 px-4 font-bold focus:ring-2 focus:ring-primary">
          ...
          <Field>
            <FieldLabel className="text-xs font-black uppercase tracking-widest opacity-50">Status</FieldLabel>
            <Select onValueChange={(val) => setValue('status', val as StudentStatus)} defaultValue={status || 'Active'}>
              <SelectTrigger className="h-12 rounded-2xl border-none bg-muted/30 px-4 font-bold focus:ring-2 focus:ring-primary">
