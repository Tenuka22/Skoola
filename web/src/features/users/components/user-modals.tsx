      ...
      <AlertDialog open={!!userToDelete} onOpenChange={(open) => !open && setUserToDelete(null)}>
        <AlertDialogContent className="rounded-[2.5rem] border-none p-10 shadow-2xl backdrop-blur-3xl ring-1 ring-white/20">
          <AlertDialogHeader>
            ...
            <AlertDialogTitle className="text-center text-3xl font-black tracking-tight">Confirm Purge?</AlertDialogTitle>
            <AlertDialogDescription className="text-center text-base font-medium leading-relaxed opacity-70">
              This will permanently erase this user identity from the Skoola infrastructure. All session data, preferences, and associations will be lost.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter className="mt-10 sm:justify-center gap-3">
            <AlertDialogCancel className="h-14 min-w-[120px] rounded-2xl border-none bg-muted/50 font-black uppercase tracking-widest transition-colors hover:bg-muted">Abort</AlertDialogCancel>
            <AlertDialogAction
      ...
      <AlertDialog open={isBulkDeleteOpen} onOpenChange={setIsBulkDeleteOpen}>
        <AlertDialogContent className="max-w-md rounded-[2.5rem] border-none p-10 shadow-2xl backdrop-blur-3xl ring-1 ring-white/20">
          <AlertDialogHeader>
            ...
            <AlertDialogTitle className="text-center text-3xl font-black tracking-tight">Mass Data Wipe</AlertDialogTitle>
            <AlertDialogDescription className="text-center text-base font-medium leading-relaxed text-destructive/80">
              FATAL ACTION: You are about to simultaneously destroy {selectedCount} user accounts. This procedure is irreversible and will remove all associated platform data.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter className="mt-10 sm:justify-center gap-3">
            <AlertDialogCancel className="h-14 min-w-[120px] rounded-2xl border-none bg-muted/50 font-black uppercase tracking-widest">Halt Action</AlertDialogCancel>
            <AlertDialogAction
