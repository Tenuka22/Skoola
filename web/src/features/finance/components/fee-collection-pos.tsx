...
type FeeCollectionPosProps = object
...
export const FeeCollectionPos = (_props: FeeCollectionPosProps) => {
  ...
  const handleProcessPayment = () => {
    if (paymentAmount >= totalDue && studentId && lineItems.length > 0) {
      alert(
        `Payment of ${paymentAmount} processed for ${studentName}. Change due: ${changeDue.toFixed(2)}`,
      )
      ...
      alert(
        'Please ensure a student is selected, items are added, and payment covers the total due.',
      )
    }
  }
