  ...
  React.useEffect(() => {
    if (timetableEntry) {
      form.reset({
        ...
        grade_period_id: timetableEntry.grade_period_id || undefined,
      })
      setUsePredefined(!!timetableEntry.grade_period_id)
    }
  }, [timetableEntry, form])
