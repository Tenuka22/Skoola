...
type AcademicStructureManagerProps = object
// TODO: Define props for data and actions

export const AcademicStructureManager = (_props: AcademicStructureManagerProps) => {
  ...
  const academicYears = [
    ...
    { id: 'ay2', name: '2025/2026', terms: [{ id: 't3', name: 'Term 1' }] },
  ]
