...
import type { AcademicYearResponse, SubjectResponse } from '@/lib/api/types.gen'
...
// Define a type for enrolled student based on usage in JSX
...
export function SubjectEnrollmentsDialog({
  ...
  const enrollments: Array<EnrolledStudent> = []
          ...
          {isLoading ? (
            ...
            <div className="grid flex-1 place-items-center px-4 py-8 text-center">
              ...
              <p className="text-sm text-muted-foreground mt-2">
                Error loading enrollments: Unknown error
              </p>
            </div>
            ...
            <div className="grid flex-1 place-items-center px-4 py-8 text-center">
              ...
              />
              <p className="text-sm text-muted-foreground mt-2">
                No students enrolled in this subject for the selected academic
                year.
              </p>
            </div>
          ) : (
