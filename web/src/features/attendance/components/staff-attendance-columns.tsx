...
export const staffAttendanceColumns: Array<ColumnDef<StaffAttendanceWithMember>> = [
  {
    id: 'staff_name',
    ...
    cell: ({ row }) => {
      ...
      return (
        <div className="flex items-center gap-2">
          <span className={cn("text-sm font-bold", row.original.status === 'Late' ? "text-orange-500" : "text-primary")}>
            {time_in}
          </span>
          <div className="flex items-center gap-1">
            <div className="h-[2px] w-4 bg-muted" />
            <span className="text-[10px] text-muted-foreground font-medium">8h 58m</span>
            <div className="h-[2px] w-4 bg-muted" />
          </div>
